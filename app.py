...
# PredictionPipeline class (updated to return raw predictions and more)
...
def main():
    ...
    if st.button("Train Model"):
        with st.spinner("Training in progress..."):
            ...
            # os.system("dvc repro")  # Uncomment if needed
    ...
    if uploaded_file is not None:
        ...
        if st.button("Predict"):
            with st.spinner("Predicting..."):
                ...
                decodeImage(b64_string, clApp.filename)
            ...
            # Optionally display as JSON for a structured view
            st.json(result)
